...
public class PercolationStatsWQU 
{
    ...
    public PercolationStatsWQU(int n, int trials) // perform trials independent experiments on an n-by-n grid
    {
    	...
    	for(int i=0;i<trials;i++)
    	   {
    		PercolationWQU perco=new PercolationWQU(n);
    ...
    public static void main(String[] args)  // test client (described below)
    {
    	...
    	int num=20;
    	int tim=10;
    	PercolationStatsWQU stats=new PercolationStatsWQU(num,tim);
